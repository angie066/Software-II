...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a href="UbGI.php" class="nav-link active">Inicio</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="jumbotron mt-3">
        <h1 class="display-2 mb-3 text-center">Bienvenido</h1><hr>
        <p class="lead mb-4 text-center">Bienvenido a la plataforma de Grupos de Investigación
